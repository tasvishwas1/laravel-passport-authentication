                            ...
                            <div class="col mega-box">
                                <div class="link-section">
                                    ...
                                    <ul class="svg-icon">
                                        ...
                                        <li><a href="comingsoon-bg-img.html"><i
                                                    data-feather="image"> </i>Coming-Image</a>
                                        </li>
                                    </ul>
                                    <div>
                                        <h6>Other Soon</h6>
        ...
        <ul class="nav-menus">
                                ...
                                <ul class="droplet-dropdown bookmark-dropdown">
                                    ...
                                    <li>
                                        <div class="row">
                                            ...
                                            <div class="col-4 text-center"><a href="javascript:void(0);" data-bs-toggle="modal"><i data-feather="settings"></i></a></div>
                                        </div>
                                    </li>
            ...
            <li class="profile-nav onhover-dropdown p-0 me-0">
                ...
                <ul class="profile-dropdown onhover-show-div">
                    ...
                    <li><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#settingModal"><i data-feather="settings"></i><span>Settings</span></a></li>
